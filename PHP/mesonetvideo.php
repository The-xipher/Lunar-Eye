...
<h1>Mesonet Video Upload</h1>

<div class="container">
    <form method="post" action="videoupload.php" enctype="multipart/form-data" id="videouploadForm">
...
<script>
    ...
    function uploadVideo() {
        ...
        xhr.open('POST', 'videoupload.php', true);

        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                // Redirect to result.php with the output as parameter
                window.location.href = 'result.php?output=' + encodeURIComponent(xhr.responseText);
            }
        };
